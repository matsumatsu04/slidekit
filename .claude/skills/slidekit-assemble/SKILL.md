...
4. **塗りは1枚に多くて1つ。カード列・番号リストでは「1つだけ塗って主役にする」をしない**（3枚・3行とも白地＋細枠線で揃える。2026-09-08 代表指示）。塗りを使うのは全面塗りの中扉・締めのカードなど、そのスライド全体の主役が1つに決まっているときだけ。`--sk-accent2` は英字ラベル・装飾線だけ
