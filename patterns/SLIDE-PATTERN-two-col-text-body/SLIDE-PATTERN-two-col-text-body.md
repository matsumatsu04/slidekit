...
category: 本文
summary: 左右2カラムにそれぞれ「見出し + 本文テキスト」を配置する基本的な本文スライド。比較・対比・2つのトピックの並列説明に最適。
scenes: 2項目の比較・説明、課題と解決策、Before/After、2つの視点の対比
tier: high
id: P013
---
...
- 本文は3〜4行が目安。それ以上になる場合は箇条書きパターン（numbered-list-with-body 等）を検討すること
