...
- **デザインは6種（`data-hstyle="a"`〜`"f"`）。見た目だけが変わり、上記metricsはどのスタイルでも変えない：**
...
| D | 2トーン下線 | 全幅の薄い下線（`--sk-soft`）＋左端だけ**濃いアクセント色の短い下線**（120px）を重ねる2トーン |
| E | ショートバー | 全幅の下線なし。タイトル直下に**短いアクセントバー**（56px×3px、角丸）のみ |
