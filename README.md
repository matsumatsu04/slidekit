...
- **構図パターン**: `patterns/`（12カテゴリ・99種。[ギャラリー](https://slidekit-sigma.vercel.app/gallery/)で一覧・プレビュー・DL可）
  - ※ 構図パターンライブラリは [slide-pattern-library/slide.md](https://github.com/slide-pattern-library/slide.md)（MIT License）を利用しています（[クレジット](./patterns/CREDITS.md)）
...
- 構図パターンライブラリ（`patterns/SLIDE-PATTERN-*`）: [slide-pattern-library/slide.md](https://github.com/slide-pattern-library/slide.md) © 2026 slide-pattern-library（MIT License。[全文](./patterns/UPSTREAM-LICENSE.txt) / [クレジット](./patterns/CREDITS.md)）
